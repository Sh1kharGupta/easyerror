...
func TestOption(t *testing.T) {
	...
	Assert(!some.IsNone())
	Assert(none.IsNone())
	Assert(some.Expect("no panic") == 123)
	AssertPanic[int, string](func() int {return none.Expect("panic")}, "panic")
	Assert(some.Unwrap() == 123)
	AssertPanic[int, *None[int]](func() int{return none.Unwrap()}, none)
